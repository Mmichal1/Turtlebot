...
def generate_launch_description():
    ...
    bringup_dir = get_package_share_directory("turtlebot_mmrs")
    ...
    declare_world_cmd = DeclareLaunchArgument(
        ...
        default_value=os.path.join(
            bringup_dir, "worlds", "turtlebot3_dqn_stage1.world"
        ),
    ...
    declare_robot1_params_file_cmd = DeclareLaunchArgument(
        ...
        description=(
            "Full path to the ROS2 parameters file to use for robot1 launched"
            " nodes"
        ),
    )
    ...
    declare_robot2_params_file_cmd = DeclareLaunchArgument(
        ...
        description=(
            "Full path to the ROS2 parameters file to use for robot2 launched"
            " nodes"
        ),
    )
